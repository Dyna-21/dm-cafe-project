...
?>
<!-- ===== HEADER ===== -->
<nav class="navbar navbar-expand-lg navbar-light sticky-top py-2" style="background-color: rgba(248,242,231,.92); backdrop-filter: blur(8px);">

  <div class="container-fluid px-4 px-md-5">
    <a href="<?php echo $path; ?>index.php" class="navbar-brand d-flex align-items-center gap-2 m-0">
      <img src="<?php echo $path; ?>assets/dm-logo-circle.png" alt="dm CAFE" style="height:85px; width:85px; object-fit:contain;">
    </a>
